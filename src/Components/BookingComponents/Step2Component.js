...
function Step2Component({patientDetails,handleInputChange2}) {
    const slots = {
        "2024-04-30":[true,false,true,true,true,false,true,false],
        "2024-05-01":[true,true,false,false,true,false,true,false],
        "2024-05-02":[true,false,true,true,false,false,true,false],
        "2024-05-03":[true,false,true,true,true,false,true,false],
      }
        ...
        <div className='pb-5' style={{borderRadius:"10px"}}>
          ...
          <div className='row mt-5 mx-5'>
            <div className='col-md-6'>
                ...
                <input type='date' name='appointmentDate' className='input-field' id='soltDate' value={patientDetails.appointmentDate} onChange={handleInputChange2} style={{width:"100%"}}/>  
            </div>
            <div className='col-md-6'>
